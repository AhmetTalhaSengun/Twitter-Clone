...
import com.sengun.twitterlast.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void kaydolSelecked (View view){

            String email =binding.usernameSignUp2.getText().toString();
    ...
    public void signIn2Selected (View view){

        TextView girisYap2 = (TextView)findViewById(R.id.girisYap2);
